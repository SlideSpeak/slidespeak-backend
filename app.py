...
def upload_file():
    ...
    try:
        ...
        # TODO: We can't use threading because of this, it seems like
        # llama index uses some async stuff internally
        start_time = time.time()
    ...
    start_time = time.time()
    # TODO: Move folder to env variable
    ...
    if len(preview_file_paths) > 0:
        # TODO: Parallelize the preview generation and upload
